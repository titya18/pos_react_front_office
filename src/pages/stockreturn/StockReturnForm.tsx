...
import { BranchType, ProductVariantType, StockReturnType, StockReturnDetailType } from "@/data_types/types";
...
const StockRequestForm: React.FC = () => {
    ...
    const [clickData, setClickData] = useState<StockReturnDetailType | null>(null);
    ...
    const { control, register, handleSubmit, setValue, watch, reset, formState: { errors } } = useForm<StockReturnType> ();
    ...
    const addOrUpdateReturnDetail = async (Detail: StockReturnDetailType) => {
        ...
        const existingIndexData = returnDetails.findIndex(
    ...
    const onSubmit: SubmitHandler<StockReturnType> = async (formData) => {
        ...
        try {
            ...
            toast.success(id ? "Stock Return updated successfully" : "Stock Return created successfully", {
                position: "top-right",
                autoClose: 2000
            });
            ...
            if (err.message) {
                ...
                toast.error("Error adding/editing stock return", {
                    position: 'top-right',
                    autoClose: 4000
                });
            }
                ...
                <div className="mb-5">
                    <form onSubmit={handleSubmit(onSubmit)}>
                                    ...
                                    >
                                        {productResults.map((variants) => (
                                            <li
                                                ...
                                                onClick={() => addOrUpdateReturnDetail({
                        ...
                        <div className="flex justify-end items-center mt-8">
                            ...
                            {statusValue === 'PENDING' &&
                                (hasPermission('Stock-Return-Create') || hasPermission('Adjust-Stock-Edit')) && (
